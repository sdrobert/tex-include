...
% Automatic Speech Recognition (grp)
...
\newglossaryentry{math.edist}{%
  ...
  description={%
    For two points $\mathbf{a},\mathbf{b} \in \mathbb{C}^N$, their Euclidean
    distance is the value $\sqrt{\sum_n (a_n - b_n)\overline{(a_n - b_n)}}$.%
  },%
}%
