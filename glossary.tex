...
\newglossaryentry{geom.emet}{%
  name={Euclidean metric},%
  description={%
    For $\mathbf{x}, \mathbf{x}' \in \mathbb{R}^N$, the metric 
    $d(\mathbf{x}, \mathbf{x'}) = \sqrt{sum_n (x_n - x'_n)^2}$. The value is
    the Euclidean distance between $\mathbf{x}$ and $\mathbf{x'}$.%
  },%
  seealso={geom.met},%
}%
\newglossaryentry{geom.edist}{%
  name={Euclidean distance},%
  description={},%
  see={geom.emet},%
}%
\newglossaryentry{geom.met}{%
  name={metric},%
...
\newglossaryentry{math.cconj}{%
  ...
  description={%
    ...
    where $a,b \in \mathbb{R}$ and $i$ is the imaginary unit, is
    $\overline{c} = a - bi$. The complex conjugate of function
    $f : \mathbb{F} \to \mathbb{C}$ is a operator $f \mapsto \overline{f}$
    \emph{s.t.} $\overline{f}(x) = \overline{f(x)}$.%
  },%
}%
...
\newglossaryentry{meas.lip}{
  name={continuous (Lipschitz, measurable)},%
  text={continuous},%
  description={%
    A measurable function is continuous
  },%
}%
...
\newglossaryentry{meas.sigma}{%
  ...
  description={
    ...
    \sigma \in \Sigma$. The resulting pair $(\mathcal{X}, \Sigma)$ is a
    measurable space.%
  }%
}%
